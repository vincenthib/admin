 ...
 <div class="box box-solid">
 	...
 	<div class="box-body no-padding">
 		<ul class="nav nav-pills nav-stacked">
 			...
 			<li><a href="modules/mailbox/index.php?filter=sent"><i class="fa fa-envelope-o"></i> Sent<span class="label label-primary pull-right"><?= $count_sent ?></span></a></li>
 			<li><a href="modules/mailbox/index.php?filter=draft"><i class="fa fa-file-text-o"></i> Drafts<span class="label label-primary pull-right"><?= $count_drafts ?></span></a></li>
 			<li><a href="#"><i class="fa fa-filter"></i> Junk <span class="label label-waring pull-right">65</span></a></li>
 			<li><a href="modules/mailbox/index.php?filter=trash"><i class="fa fa-trash-o"></i> Trash<span class="label label-primary pull-right"><?= $count_trash ?></span></a></li>
 		</ul>
 	</div><!-- /.box-body -->
 </div><!-- /. box -->
 <div class="box box-solid">
